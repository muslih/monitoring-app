      ...
      <div class="row">
          ...
          <div class="col-xs-12">
            ...
            <table class="table table-bordered table-hover table-striped">
              ...
              <tbody>
                  <?php $produks = Tipe::all() ?>
                  <?php $no = 1 ?>
                  <?php foreach ($produks as $produk) { ?>
                  <tr>
                      <td><?php echo $no ?></td>
                      <td><?php echo $produk->detail_tipe ?></td>
                      <td><?php echo $produk->nama_tipe ?></td>
                      <td>

                          <a href="?page=master&master=tipe&hapus=<?php echo $produk->id ?>"  class="btn btn-warning btn-circle" rel="tooltip" data-original-title="Hapus data"><i class="fa fa-times"></i></a>
                      </td>
                  </tr>
                  <?php $no ++ ?>
                  <?php } ?>
